...
// // // --- MOCK DATA FOR CHARTS (AI/Vision Context) ---

// // // Chart 1: Timeline Analysis (Simulating a session timeline)
// // const sessionData = [
// //   { time: "00:00", confidence: 65, engagement: 70 },
// //   { time: "02:00", confidence: 72, engagement: 75 },
// //   { time: "04:00", confidence: 68, engagement: 82 },
// //   { time: "06:00", confidence: 85, engagement: 88 },
// //   { time: "08:00", confidence: 90, engagement: 85 },
// //   { time: "10:00", confidence: 88, engagement: 92 },
// //   { time: "12:00", confidence: 95, engagement: 90 },
// // ];

// // // Chart 2: Radar Analysis of Communication Skills
// // const skillMetrics = [
// //   { subject: "Vocal Tone", A: 85, fullMark: 100 },
// //   { subject: "Facial Expr.", A: 92, fullMark: 100 },
// //   { subject: "Posture", A: 78, fullMark: 100 },
// //   { subject: "Eye Contact", A: 88, fullMark: 100 },
// //   { subject: "Gesture Usage", A: 70, fullMark: 100 },
// //   { subject: "Pacing", A: 82, fullMark: 100 },
// // ];

// // const BodyLanguageProject = () => {
...
// //     const portfolioRef = ref(database, "Protfolio/body-language-ai");
...
// //               <ScanFace className="text-[#677ED6] animate-pulse" size={24} />
// //             </div>
// //           </div>
...
// //       <Seo
// //         title={data.title || "AI Body Language Analysis"}
// //         description={
// //           data.overview
// //             ? data.overview.slice(0, 160)
// //             : "AI-powered communication analysis system."
// //         }
// //         url="/portfolio/body-language-ai"
// //       />
...
// //             </Link>
// //             <span className="text-slate-700">/</span>
// //             <span className="text-white">Analysis AI</span>
// //           </motion.div>
// //         </div>
...
// //                         {item.icon === "scan" && <ScanFace size={18} />}
// //                         {item.icon === "video" && <Video size={18} />}
// //                         {item.icon === "mic" && <Mic size={18} />}
// //                       </div>
// //                       <div>
...
// //                   <Layers size={20} className="text-[#677ED6]" /> Detection
// //                   Capabilities
// //                 </h3>
...
// //                 <BarChart3 size={20} className="text-[#677ED6]" /> Performance
// //                 Metrics
// //               </h3>

// //               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
// //                 {/* Chart 1: Timeline Confidence */}
...
// //                       Confidence vs Engagement over session duration
// //                     </p>
// //                   </div>
...
// //                     <Eye size={18} className="text-[#677ED6]" /> Key
// //                     Deliverables
// //                   </h3>
...
// // export default BodyLanguageProject;
...
// // --- MOCK GALLERY (Fallback if no data in Firebase) ---
// const mockGallery = [
//   {
//     id: 1,
...
//   {
//     id: 6,
//     src: "https://dummyimages.netlify.app/portfolioimagaes/Body%20langyage/6.jpg",
//     label: "Security Grid",
//   },
//   {
//     id: 7,
//     src: "https://dummyimages.netlify.app/portfolioimagaes/Body%20langyage/7.jpg",
//     label: "Security Grid",
//   },
// ];
...
//   // Determine images to use (Firebase data or Mock)
...
//             {/* ========================================================================= */}
//             {/* --- NEW: UNIQUE CAROUSEL SECTION (FILM STRIP STYLE) --- */}
//             {/* ========================================================================= */}
//             <motion.section variants={fadeInUp} className="space-y-6">
//               <h3 className="text-xl font-bold flex items-center gap-2 mb-4">
//                 <ImageIcon size={20} className="text-[#677ED6]" />
//                 Visual Analysis Log
//               </h3>

//               <div className="h-[300px] w-full flex gap-2 overflow-hidden rounded-2xl border border-white/10 bg-[#111625] p-2">
...
//                       activeImage === index
//                         ? "flex-[4]"
//                         : "flex-1 grayscale opacity-50 hover:opacity-80"
//                     }`}
//                   >
//                     {/* Image */}
//                     <img
...
//                     {activeImage === index && (
//                       <div className="absolute inset-0 bg-gradient-to-t from-[#0A0118]/90 via-transparent to-transparent">
//                         <motion.div
//                           initial={{ opacity: 0 }}
//                           animate={{ opacity: 1 }}
//                           className="absolute bottom-0 left-0 w-full p-4"
//                         >
//                           <div className="flex items-center gap-2 text-[#677ED6] mb-1">
...
//                         <div className="absolute top-0 left-0 w-full h-1 bg-[#677ED6]/50 shadow-[0_0_15px_#677ED6] animate-[scan_2s_linear_infinite]"></div>
//                       </div>
//                     )}
...
//                         <div className="rotate-[-90deg] whitespace-nowrap text-xs text-white/70 uppercase tracking-widest font-mono">
//                           Img_0{index + 1}
//                         </div>
//                       </div>
//                     )}
...
//         {/* --- MAIN HERO CAROUSEL --- */}
//         <motion.div variants={fadeInUp} className="relative w-full mb-20 group">
//           <div className="absolute -inset-1 bg-gradient-to-r from-[#677ED6] to-purple-600 rounded-3xl opacity-30 blur group-hover:opacity-50 transition duration-1000"></div>

//           {/* Carousel Container */}
//           <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-[#0A0118] h-[500px] flex gap-2 p-2">
//             {galleryImages.map((img, index) => (
//               <motion.div
//                 key={index}
//                 layout
...
//                 {/* Active Overlay Effect */}
//                 {activeImage === index && (
//                   <div className="absolute inset-0 bg-gradient-to-t from-[#0A0118] via-transparent to-transparent opacity-90">
//                     <motion.div
//                       initial={{ opacity: 0 }}
//                       animate={{ opacity: 1 }}
//                       className="absolute bottom-20 left-6 w-full"
//                     >
//                       <div className="flex items-center gap-2 text-[#677ED6] mb-1">
//                         <ScanFace size={16} className="animate-pulse" />
//                         <span className="text-xs font-mono uppercase tracking-widest">
...
//                     {/* Scanning Line Animation */}
//                     <div className="absolute top-0 left-0 w-full h-1 bg-[#677ED6]/50 shadow-[0_0_15px_#677ED6] animate-[scan_3s_linear_infinite]"></div>
//                   </div>
//                 )}
...
//           {/* Floating Metadata (Overlay on top of Carousel) */}
//           <div className="absolute bottom-6 left-8 right-8 flex flex-wrap gap-4 pointer-events-none z-20">
//             {data.meta?.map((item, idx) => (
//               <div
//                 key={idx}
//                 className="flex items-center gap-3 bg-[#0A0118]/80 backdrop-blur-md border border-white/10 px-5 py-3 rounded-xl shadow-lg"
//               >
//                 <div className="text-[#677ED6]">
//                   {item.icon === "scan" && <ScanFace size={18} />}
//                   {item.icon === "video" && <Video size={18} />}
          ...
          <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-[#0A0118] h-[500px] flex gap-2 p-2">
            {galleryImages.map((img, index) => (
              ...
              >
                ...
                {/* Active Overlay Effect (Cleaner version without scan line) */}
                {activeImage === index && (
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0A0118] via-transparent to-transparent opacity-100">
                    <motion.div
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      className="absolute bottom-20 left-6 w-full"
