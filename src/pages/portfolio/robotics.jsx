...
// --- MOCK DATA FOR CHARTS (Robotics/RL Context) ---

// Chart 1: RL Training Curve (Mean Reward over Episodes)
const trainingData = [
  { episode: 0, reward: -150 },
  { episode: 500, reward: -80 },
  { episode: 1000, reward: -20 },
  { episode: 1500, reward: 45 },
  { episode: 2000, reward: 120 },
  { episode: 2500, reward: 180 },
  { episode: 3000, reward: 210 },
  { episode: 3500, reward: 225 },
];

// Chart 2: Success Rate Comparison (Rigid Script vs AI Policy)
const successRateData = [
  { scenario: "Static Object", script: 95, ai: 98 },
  { scenario: "Moving Target", script: 40, ai: 85 },
  { scenario: "Obstructed", script: 15, ai: 72 },
  { scenario: "New Object", script: 0, ai: 90 },
];

const RoboticsControlProject = () => {
  ...
  useEffect(() => {
    ...
    const portfolioRef = ref(database, "Protfolio/robotics-control");
        ...
        <div className="flex flex-col items-center gap-6 z-10">
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <Bot className="text-[#677ED6] animate-bounce" size={24} />
            </div>
          </div>
  ...
  return (
    <div className="bg-[#0A0118] text-white min-h-screen relative font-sans selection:bg-[#677ED6]/30">
      <Seo
        title={data.title || "AI Robotics Control"}
        description={
          data.overview
            ? data.overview.slice(0, 160)
            : "Reinforcement learning for robotic manipulation."
        }
        url="/portfolio/robotics-control"
      />
      ...
      >
        ...
        <div className="flex flex-col items-center text-center mb-16 max-w-4xl mx-auto">
          ...
          >
            ...
            {data.tag || "Reinforcement Learning"}
          </motion.div>
                  ...
                  {data.meta?.map((item, idx) => (
                    ...
                    >
                      <div className="text-[#677ED6]">
                        {item.icon === "bot" && <Bot size={18} />}
                        {item.icon === "cpu" && <Cpu size={18} />}
                        {item.icon === "eye" && <Eye size={18} />}
                        {!["bot", "cpu", "eye"].includes(item.icon) && (
                          <Bot size={18} />
                        )}
                      </div>
                      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7 space-y-12">
            ...
            {data.scope && (
              <motion.section variants={fadeInUp}>
                <h3 className="text-xl font-bold mb-6 flex items-center gap-2">
                  <Layers size={20} className="text-[#677ED6]" /> Capabilities &
                  Modules
                </h3>
            ...
            {/* --- VISUALIZATION: ROBOTICS ANALYTICS --- */}
            <motion.section variants={fadeInUp} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[#111625] border border-white/10 rounded-2xl p-5 shadow-lg">
                  <div className="mb-4">
                    ...
                    <p className="text-xs text-slate-500">
                      Mean Reward per Episode (Training Phase)
                    </p>
                  </div>
                ...
                {/* Chart 2: Sim-to-Real Success Rate */}
                <div className="bg-[#111625] border border-white/10 rounded-2xl p-5 shadow-lg flex flex-col justify-between">
                  <div className="mb-4">
                    ...
                    <p className="text-xs text-slate-500">
                      Success Rate: Scripted vs RL Policy
                    </p>
                  </div>
              ...
              {data.deliverables && (
                ...
                >
                  <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-2">
                    <Box size={18} className="text-[#677ED6]" /> Key
                    Deliverables
                  </h3>
...
export default RoboticsControlProject;
