...
// --- MOCK DATA FOR CHARTS (Political/Civic Context) ---
const engagementData = [
  { name: "Week 1", engagement: 15000, reach: 45000 },
  { name: "Week 2", engagement: 22000, reach: 52000 },
  { name: "Week 3", engagement: 18000, reach: 49000 },
  { name: "Week 4", engagement: 35000, reach: 78000 },
  { name: "Week 5", engagement: 42000, reach: 95000 },
  { name: "Election Day", engagement: 85000, reach: 120000 },
];
...
const PoliticoProject = () => {
  ...
  // --- FETCH DATA ---
  useEffect(() => {
    // Pointing to "Protfolio/Politico"
    const portfolioRef = ref(database, "Protfolio/Politico");
    ...
    const unsubscribe = onValue(
      ...
      (snapshot) => {
        if (snapshot.exists()) {
          ...
          console.warn("No data found at 'Protfolio/Politico'");
        ...
        <div className="flex flex-col items-center gap-6 z-10">
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <Landmark className="w-6 h-6 text-[#677ED6] opacity-50" />
            </div>
          </div>
  ...
  return (
    <div className="bg-[#0A0118] text-white min-h-screen relative font-sans selection:bg-[#677ED6]/30">
      <Seo
        title={data.title || "Politico Platform"}
        description={
          data.overview ? data.overview.slice(0, 160) : "Civic tech solutions."
        }
        url="/portfolio/politico"
      />
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[20%] right-[-10%] w-[600px] h-[600px] bg-blue-800/20 rounded-full blur-[120px]" />
        <div className="absolute bottom-[0%] left-[-10%] w-[500px] h-[500px] bg-[#677ED6]/10 rounded-full blur-[100px]" />
        {/* Subtle Map-like Dots Pattern */}
        <div className="absolute inset-0 bg-[radial-gradient(#677ED6_1px,transparent_1px)] [background-size:40px_40px] opacity-[0.05]"></div>
      </div>
      ...
      >
        ...
        {data.imageUrl && (
          ...
          >
            <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-[#677ED6] rounded-3xl opacity-20 blur group-hover:opacity-40 transition duration-1000"></div>
                  ...
                  {data.meta?.map((item, idx) => (
                    ...
                    >
                      <div className="text-[#677ED6]">
                        ...
                        {item.icon === "clock" && <MessageSquare size={18} />}
          ...
          <div className="lg:col-span-7 space-y-12">
            ...
            {data.scope && (
              <motion.section variants={fadeInUp}>
                <h3 className="text-xl font-bold mb-6 flex items-center gap-2">
                  <Radio size={20} className="text-[#677ED6]" /> Key Initiatives
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {data.scope.map((item, index) => (
                    ...
                    >
                      <div className="w-2 h-2 rounded-full border-2 border-[#677ED6] mt-1.5 shrink-0"></div>
            ...
            <motion.section variants={fadeInUp} className="space-y-6">
              <h3 className="text-xl font-bold flex items-center gap-2">
                <BarChart3 size={20} className="text-[#677ED6]" /> Engagement
                Analytics
              </h3>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Chart 1: Voter/User Engagement */}
                ...
                <div className="bg-[#111625] border border-white/10 rounded-2xl p-5 shadow-lg flex flex-col justify-between">
                  ...
                  <div className="h-[180px] w-full">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={sentimentStats} layout="vertical">
...
export default PoliticoProject;
