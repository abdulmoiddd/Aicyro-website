...
// --- MOCK DATA FOR CHARTS (Real Estate/Space Context) ---
const occupancyData = [
  { name: "Jan", occupancy: 65, inquiries: 120 },
  { name: "Feb", occupancy: 72, inquiries: 145 },
  { name: "Mar", occupancy: 78, inquiries: 180 },
  { name: "Apr", occupancy: 85, inquiries: 210 },
  { name: "May", occupancy: 92, inquiries: 250 },
  { name: "Jun", occupancy: 96, inquiries: 310 },
  { name: "Jul", occupancy: 98, inquiries: 340 },
];

const satisfactionStats = [
  { name: "Market Avg", value: 3.8 },
  { name: "Cove Spaces", value: 4.9 },
];
...
const CoveProject = () => {
  ...
  // --- FETCH DATA ---
  useEffect(() => {
    // Pointing to "Protfolio/Cove"
    const portfolioRef = ref(database, "Protfolio/Cove");
    ...
    const unsubscribe = onValue(
      ...
      (snapshot) => {
        if (snapshot.exists()) {
          ...
          console.warn("No data found at 'Protfolio/Cove'");
        ...
        <div className="flex flex-col items-center gap-6 z-10">
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <Home className="w-6 h-6 text-[#677ED6] opacity-50" />
            </div>
          </div>
  ...
  return (
    <div className="bg-[#0A0118] text-white min-h-screen relative font-sans selection:bg-[#677ED6]/30">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] left-[20%] w-[500px] h-[500px] bg-[#677ED6]/10 rounded-full blur-[120px]" />
      ...
      >
        ...
        {data.imageUrl && (
          ...
          >
            <div className="absolute -inset-1 bg-gradient-to-r from-[#677ED6] to-teal-500 rounded-3xl opacity-20 blur group-hover:opacity-40 transition duration-1000"></div>
          ...
          <div className="lg:col-span-7 space-y-12">
            ...
            {data.overview && (
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-bold">Space Overview</h2>
                </div>
            ...
            {data.scope && (
              <motion.section variants={fadeInUp}>
                <h3 className="text-xl font-bold mb-6 flex items-center gap-2">
                  <LayoutDashboard size={20} className="text-[#677ED6]" />{" "}
                  Features & Scope
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {data.scope.map((item, index) => (
                    ...
                    >
                      <Sofa className="w-5 h-5 text-[#677ED6] shrink-0 mt-0.5" />
            ...
            <motion.section variants={fadeInUp} className="space-y-6">
              <h3 className="text-xl font-bold flex items-center gap-2">
                <Home size={20} className="text-[#677ED6]" /> Property Metrics
              </h3>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Chart 1: Occupancy Rates */}
                <div className="bg-[#111625] border border-white/10 rounded-2xl p-5 shadow-lg">
                  <div className="mb-4">
                    <h4 className="text-sm font-semibold text-slate-200">
                      Occupancy Trend
                    </h4>
                    <p className="text-xs text-slate-500">Unit utilization %</p>
                  </div>
                ...
                {/* Chart 2: Tenant Satisfaction */}
                <div className="bg-[#111625] border border-white/10 rounded-2xl p-5 shadow-lg flex flex-col justify-between">
                  <div className="mb-4">
                    <h4 className="text-sm font-semibold text-slate-200">
                      Tenant Satisfaction
                    </h4>
                    <p className="text-xs text-slate-500">Rating out of 5.0</p>
                  </div>
                  <div className="h-[180px] w-full">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={satisfactionStats} layout="vertical">
