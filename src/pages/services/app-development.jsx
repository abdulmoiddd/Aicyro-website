...
const AppDevelopment = () => {
  ...
  useEffect(() => {
    // Pointing to the new App Development path
    const serviceRef = ref(database, "Servicessubpages/AppDevelopment");
    ...
    <div className="bg-[var(--background)] min-h-screen text-[var(--foreground)] relative font-sans selection:bg-[var(--accent-blue)] selection:text-white transition-colors duration-300">
      ...
      <div className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          {/* DIAGRAM TRIGGER: Visualizing the app development process */}
          <motion.div variants={itemVariants} className="mt-8 flex justify-center">
             

[Image of mobile application development lifecycle]
