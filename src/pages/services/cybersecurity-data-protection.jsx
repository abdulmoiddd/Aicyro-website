...
const CyberSecurity = () => {
      ...
      <React.Fragment key={index}>
        ...
        {line.trim().startsWith("•") || line.trim().startsWith("✔") ? (
          <span className="block pl-4 mb-2 text-white/90">
            {/* Updated Bullet Color to match SaaS theme */}
            <span className="text-[#677ED6] mr-2">{line.trim().charAt(0)}</span>
            {line.trim().substring(1)}
          </span>
        ) : /* Numbered Lists (e.g., "1. Zero-Trust") */
        /^[0-9]+\./.test(line.trim()) ? (
          <span className="block mt-6 mb-2 text-lg font-bold text-[#677ED6]">
            {line.trim()}
          </span>
        ) : (
          /* Standard Paragraph */
  ...
  return (
    <div className="bg-[#0A0118] min-h-screen text-white relative font-sans selection:bg-[#677ED6] selection:text-white">
      ...
      <div className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            {/* Updated Gradient to match SaaS Page */}
      ...
      {/* --- BACKGROUND GLOWS (Updated to Purple/Blue match) --- */}
