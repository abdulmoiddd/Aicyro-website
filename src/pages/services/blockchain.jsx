...
const Blockchain = () => {
  ...
  useEffect(() => {
    // Pointing to the new Blockchain path
    const serviceRef = ref(database, "Servicessubpages/Blockchain");
  ...
  const formatText = (text) => {
    ...
    return text.split("\n").map((line, index) => (
      <React.Fragment key={index}>
        ...
        line.trim().startsWith("❌") ||
        line.trim().match(/^\d\./) ? (
          // UPDATED: Text color uses foreground-muted
          <span className="block pl-4 mb-2 text-[var(--foreground-muted)]/90">
            {/* UPDATED: Bullet color uses accent-blue */}
    ...
    <div className="bg-[var(--background)] min-h-screen text-[var(--foreground)] relative font-sans selection:bg-[var(--accent-blue)] selection:text-white transition-colors duration-300">
      ...
      <div className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          {/* DIAGRAM TRIGGER: Visualizing the blockchain ecosystem */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 relative">
          ...
          <main className="lg:col-span-9 space-y-12">
            ...
            {/* DIAGRAM TRIGGER: Visualizing smart contract logic before sections */}
            <div className="mb-8">
