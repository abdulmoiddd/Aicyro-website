...
//           >
//             <span className="text-[#7746D5]">AI vs Manual Work:</span>
...
//             <span className="text-white font-bold">operational multiplier</span>
//             .
//           </motion.p>
...
//                 automation <strong>cut operational time by 40%</strong>,
...
//                 <CheckCircle size={16} className="text-purple-500" /> AI can
//                 process hundreds of tasks simultaneously.
//               </li>
//               <li className="flex items-center gap-2">
//                 <CheckCircle size={16} className="text-purple-500" /> Implement
//                 AI workflow tools (Zapier AI, Make.com AI, Aicyro AI
//                 Orchestrator).
//               </li>
//             </ul>
...
//             <div className="bg-white/5 p-4 rounded-lg border border-white/10 flex items-start gap-3 my-6 not-prose">
...
//                   by <strong>over 90%</strong>, saving thousands in manual
//                   corrections.
//                 </p>
//               </div>
//             </div>
...
//                 <strong>reduced operational costs by 30%</strong>, handling the
//                 same workload with fewer employees.
//               </p>
//             </HighlightBox>
...
//                     <p className="text-xs text-gray-400">Ops Intelligence</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
          ...
          <article className="lg:col-span-7 prose prose-invert prose-lg max-w-none text-[var(--foreground-muted)]">
            ...
            >
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                  <button className="flex items-center justify-center gap-2 bg-[var(--primary)] text-white font-bold px-6 py-3 rounded-lg hover:opacity-90 transition-colors shadow-lg">
                    Book Consultation <ArrowRight size={18} />
                  </button>
                </div>
