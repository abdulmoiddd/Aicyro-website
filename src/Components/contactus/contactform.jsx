...
// // Helper to map DB icon strings to New Design Icons (Lucide)
...
//           <p className="text-[var(--foreground-muted)]">Loading Contact Section...</p>
//         </div>
//       </section>
//     );
//   }
...
//   return (
//     // UPDATED: Added 'pt-32' for top padding
...
//               >
//                 <span>{submissionStatus === "submitting" ? "Sending..." : formContent.submitButtonText}</span>
...
//   ArrowDown // Icon for Dropdowns
// } from "lucide-react";

// import { ref, onValue, push, serverTimestamp } from "firebase/database";
// import { database } from "../../lib/firebase";

// // --- SERVICE DATA (Duplicated to ensure availability for Dropdowns) ---
// const SERVICES_DATA = [
//   {
//     id: "ai",
...
// // Helper to map DB icon strings to Icons
// const renderIcon = (iconName, className) => {
//   switch (iconName) {
//     case "location": return <MapPin className={className} />;
//     case "mail": return <Mail className={className} />;
...
//     email: "",
//     company: "",
//     coreService: "", // New Field
//     subService: "",  // New Field
//     message: ""
//   });
...
//         setContactData(snapshot.val());
//       } else {
//         // Fallback default data if Firebase is empty
//         setContactData({
//             formContent: {
...
//     // Logic: If Core Service changes, reset Sub Service
//     if (name === "coreService") {
...
//   // --- GET SUB-SERVICES FOR SELECTED CORE SERVICE ---
...
//               {/* --- NEW DROPDOWN 2: SUB SERVICE (Dependent) --- */}
//               <div className="relative group">
//                 <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
