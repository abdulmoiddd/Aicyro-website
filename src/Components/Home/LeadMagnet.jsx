...
//       {/* --- BACKGROUND LAYER: Using Theme Variables --- */}
//       <div
...
//           viewport={{ once: true }}
//           className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-8 border backdrop-blur-md"
//           style={{
//             backgroundColor: "rgba(138, 43, 226, 0.1)", // Primary with low opacity
...
//         >
//           We review your current systems and provide actionable insights to improve security, performance, and automation.
//         </motion.p>
...
//           <a href="/contact">
//             <button
//               className="group relative inline-flex items-center justify-center text-lg font-bold px-10 py-4 rounded-full shadow-xl transition-all duration-300 hover:scale-105"
//               style={{
//                 backgroundColor: "var(--primary)",
//                 color: "#ffffff", // Always white text on Primary button
//                 boxShadow: "0 10px 30px -10px var(--primary)", // Colored shadow
//               }}
//             >
  ...
  return (
    <section className="relative w-full py-24 overflow-hidden">
      ...
      <motion.div
        animate={{ opacity: [0.3, 0.5, 0.3], scale: [1, 1.1, 1] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        // UPDATED: Background uses primary variable
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[140%] h-[140%] blur-[120px] z-0 pointer-events-none bg-[var(--primary)] opacity-15"
      />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          // UPDATED: Replaced inline rgba with Tailwind opacity utility and border variable
        ...
        >
          <a href="/contact">
            {/* UPDATED: Button background and shadow use variables */}
