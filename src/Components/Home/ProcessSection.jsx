...
//       {/* (Keep your Background code here - omitted for brevity) */}
...
//         {/* GRID SYSTEM
//             Using LayoutGroup ensures all items act as a single coordinated physics system
//         */}
//         <LayoutGroup>
...
//               // Logic to determine row behavior (2 items top, 3 items bottom)
//               // We use flex-basis to force the wrap after the 2nd item
...
//                   animate={{
//                     // FLEX LOGIC:
//                     // Top row items take up ~45% base, Bottom ~30% base.
//                     // When hovered, flex-grow increases to dominate space.
//                     flexBasis: isTopRow ? "40%" : "30%",
//                     flexGrow: isHovered ? 2 : 1,

//                     // HEIGHT:
//                     height: isHovered ? 500 : isDimmed ? 300 : 400,
...
//                   }}
//                   // Spring makes the resize elastic and prevents "jumps"
//                   transition={{
//                     type: "spring",
//                     stiffness: 300,
//                     damping: 30,
//                   }}
//                   style={{
//                     // Prevent items from becoming too small to read
//                     minWidth: "280px",
//                   }}
//                 >
//                   {/* Hover Gradient */}
...
//                   {/* CONTENT CONTAINER
//                       We use a min-width here to prevent text squashing.
//                       Even if the parent card shrinks, this div stays wide
//                       and the parent just clips the overflow.
//                   */}
...
//                             ? "var(--secondary)"
//                             : "transparent",
//                           color: isHovered ? "#fff" : "var(--foreground-muted)",
//                         }}
//                       >
...
//                         animate={{ fontSize: isHovered ? "4rem" : "2.5rem" }}
//                       >
//                         {step.id}
//                       </motion.span>
//                     </div>
...
//                         animate={{
//                           fontSize: isHovered ? "2.5rem" : "1.5rem",
//                           color: isDimmed
...
//                         animate={{
//                           height: isHovered ? "auto" : isDimmed ? 0 : "auto",
