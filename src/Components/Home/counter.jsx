...
const CounterItem = ({
  ...
  // Handle the special case for 4.9 (Client Ratings)
...
const Counter = () => {
  ...
  const stats = [
    { label: "COMPLETED PROJECT", target: "250", suffix: "+" },
    { label: "HAPPY CLIENT", target: "200", suffix: "+" },
    { label: "YEARS OF EXPERIENCE", target: "10", suffix: "+" },
    { label: "CLIENT RATINGS", target: "4.9", suffix: " / 5" },
  ];
